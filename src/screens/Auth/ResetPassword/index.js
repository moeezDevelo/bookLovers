...
import { forgotPassword } from '../../../utills/ApiFunctions';
    ...
    const _forgotPassword = async () => {
        ...
        if (isEmail) {
            ...
            if (response?.success) {
                ...
                navigation.navigate('ResetConfirmPassword', { Username: Username })
            } else {
                dispatch(setButtonLoader(false))
                ...
                <View style={styles.mainViewContainer}>
                    ...
                    >
                        ...
                        <View style={styles.headingContainer}>
                            <Text style={styles.headingText}>Let's find your account</Text>
                        ...
                        <Button title='FIND ACCOUNT' containerStyles={styles.confirmButton}
